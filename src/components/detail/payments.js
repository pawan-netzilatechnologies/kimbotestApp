...
<a href="#" className="active">Current Plan</a>
<a href="#">Free</a>
</Card>
<Row>
<Col xs="6">
<Card className="current-plan-block">
<CardTitle tag="h3" className="text-center"><strong>Dormant</strong></CardTitle>
<CardText className="text-center">Remove all the barriers to entry in a new market with this basic plan</CardText>
<List>
...
<Col xs="6">
<Card className="current-plan-block">
<CardTitle tag="h3" className="text-center"><strong>Exempt</strong></CardTitle>
<CardText className="text-center">Execute your business plan and receive revenues into a digital bank account</CardText>
<List>
    <li>Mandatory corporate secretary and nominee director appointments</li>
<li>Resolutions to cover change of financial year, registered address, business activities</li>
<li>Hassle-free compliance, including AR and AGM</li>
...
<a href="#">Contact us</a>
<a href="#" className="current-plan-checkout">Checkout</a>
