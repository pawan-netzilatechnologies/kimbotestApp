...
<Card className="steps-block">
     <Card className="section-title">
                ...
                <strong>Are you the ultimate beneficial owner of this business?</strong> 
                <div>
                                          <a
                                                href="#"
                                                id="TooltipExample"
                ...
                <CardText>
                Ultimate beneficial owner is a person who owns more than 25% of the business.
                </CardText>  
      </Card>   
      <Row>
            <Col xs="6">
                  <Card className="steps-detail-block">
                        <img src={ icon3 }/>
                        <CardText>
                        Yes, I am the ultimate<br/>
                        beneficial owner of this<br/>
                        business
                        </CardText>  
                  </Card>
            </Col>
